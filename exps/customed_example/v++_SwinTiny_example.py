...
class Exp(MyExp):
    def __init__(self):
        ...
        self.data_dir = (
            "/home/veesion/Bag-detector/YOLOV/videos_dataset"  # set your dataset path
        )
        self.train_ann = "yolov_ovis_train.json"  # set your train annotation file
        self.val_ann = "yolov_ovis_val.json"  # set your val annotation file

        self.num_classes = 13  # config you classes number here
    ...
    def get_model(self):
        ...
        more_args = {
            ...
            "use_pre_nms": self.use_pre_nms,
            "cat_ota_fg": self.cat_ota_fg,
        ...
        if "optimizer" not in self.__dict__:
            ...
            for k, v in self.model.named_modules():
                ...
                if isinstance(v, nn.BatchNorm2d) or "bn" in k:
                    ...
                    if (
                        "head.stem" in k
                        or "head.reg_convs" in k
                        or "head.cls_convs" in k
                    ):
                        pg3.append(v.weight)
    ...
    def get_eval_loader(self, batch_size, tnum=None, data_num_workers=8, formal=False):
        ...
        dataset_val = vid.OVIS(
            data_dir=self.data_dir,  # change to your own dataset
        ...
        val_loader = vid.get_trans_loader(
